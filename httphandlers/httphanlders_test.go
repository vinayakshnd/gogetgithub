...
const (
	redirectPage = `<a href="https://github.com/login/oauth/authorize?scope=repo&amp;client_id=35cfafe67abea4ab8940&amp;redirect_uri=http://70.0.0.137:20080/login/github/callback">Moved Permanently</a>.`
)
